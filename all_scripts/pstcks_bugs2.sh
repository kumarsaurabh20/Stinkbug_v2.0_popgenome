...
#SBATCH --job-name=stacks2                         # Job name
...
#SBATCH --output=bugs2_%j.log                        # Standard output and error log
...
out_dir=$work_dir/mapping/pstacks_bugs2
log_file=$out_dir/pstacks.oe
#
...
do
        ...
        pstacks -t bam -f $f1 -i $f2 -o $out_dir -p 8 &> ${outfile}.pstacks.oe
done < $work_dir/bugs2.pstacks.list 
date
