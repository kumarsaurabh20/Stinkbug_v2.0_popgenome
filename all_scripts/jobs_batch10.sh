...
#SBATCH --output=psmc10_parallel_%j.log
...
samtools mpileup -C50 -uf /nobackup/beegfs/workspace/ks575/Data/Stinkbug/SB_population_data/Euschistus/mapping_new/alignments/PSMC/Final_corrected.fasta /nobackup/beegfs/workspace/ks575/Data/Stinkbug/SB_population_data/Euschistus/mapping_new/alignments/PSMC/BASD32.RG.bam | bcftools call -c - | vcfutils.pl vcf2fq -d 10 -D 100 | gzip > /nobackup/beegfs/workspace/ks575/Data/Stinkbug/SB_population_data/Euschistus/mapping_new/alignments/PSMC/BASD32.diploid.fq.gz
